...
//	printk("wujun Osi func_COEF_DOWNLOAD GYRSNS = %ud \n",GYRSNS);
}
...
void	download( OIS_UWORD u16_type, OIS_UWORD u16_coef_type ){
	...
	while( 1 ){
		...
		if( lp != 0 ){
			...
			/* Data Transfer */ //jun modify for test
...
void SET_FADJ_PARAM( const _FACT_ADJ *param )
{
	...
	I2C_OIS_per_write(_P_30_ADC_CH0, param->gl_CURDAT);
					//_P_37_ADC_CH0  _P_37_ADC_CH7?  _P_30_ADC_CH0? //jun modfy
...
//  **** Scence parameter
//  *****************************************************
#define	ANGLE_LIMIT_DEG	1.2       											// Angle limit[deg]
#define	G_SENSE			87.5												// [LSB/dps] for ICG20660
ADJ_STS	func_SET_SCENE_PARAM_for_NewGYRO_Fil(OIS_UBYTE u16_scene, OIS_UBYTE u16_mode, OIS_UBYTE filter, OIS_UBYTE range, const _FACT_ADJ *param)	// RHM_HT 2013/04/15	Change "typedef" of return value
{
	...
	OIS_UWORD u16_dat_SCENE_NIGHT_1[4] = { 0x7FE0,  0/* ANGLE_LIMIT*/,   G_SENSE * 16,   0x0100,  };	// 16dps
	OIS_UWORD u16_dat_SCENE_NIGHT_2[4] = { 0x7FFF,   0/* ANGLE_LIMIT*/,   G_SENSE * 16,   0x0080,  };	// 16dps
	OIS_UWORD u16_dat_SCENE_NIGHT_3[4] = { 0x7FF0,   0/* ANGLE_LIMIT*/,   G_SENSE * 16,   0x0080,  };	// 16dps

	OIS_UWORD u16_dat_SCENE_D_A_Y_1[4] = { 0x7FE0,   0/* ANGLE_LIMIT*/,   G_SENSE * 40,   0x0100,  };	// 40dps
	OIS_UWORD u16_dat_SCENE_D_A_Y_2[4] = { 0x7F80,   0/* ANGLE_LIMIT*/,   G_SENSE * 40,   0x0080,  };	// 40dps
	OIS_UWORD u16_dat_SCENE_D_A_Y_3[4] = { 0x7F00,   0/* ANGLE_LIMIT*/,   G_SENSE * 40,   0x0080,  };	// 40dps

	OIS_UWORD u16_dat_SCENE_SPORT_1[4] = { 0x7FE0,   0/* ANGLE_LIMIT*/,   G_SENSE * 60,   0x0100,  };	// 60dps
	OIS_UWORD u16_dat_SCENE_SPORT_2[4] = { 0x7F80,   0x15E0, /*0x1A40 0x15E0  ANGLE_LIMIT*/   G_SENSE * 60,   0x0080,  };	// 60dps
 	OIS_UWORD u16_dat_SCENE_SPORT_3[4] = { 0x7FFF,   0/* ANGLE_LIMIT*/,   G_SENSE * 60,   0x0080,  };	// 60dps
	...
	{
 		OIS_ULONG	temp;
 //		OIS_UWORD	ANGLE_LIMIT = (OIS_UWORD)(GYRSNS >> 1);
 //		OIS_UWORD	ANGLE_LIMIT = (OIS_UWORD)(0x2bc0 * ANGLE_LIMIT_DEG); //0x2bc0 0x381d 0x15E0
 		OIS_UWORD	ANGLE_LIMIT = (OIS_UWORD)(0x15E0 * ANGLE_LIMIT_DEG); //0x2bc0 0x381d 0x15E0
    ...
    /////jun add for close ois
    	// Position Servo ON ( OIS OFF )
	//I2C_OIS_mem_write( _M_EQCTL, 0x0000 );
//	I2C_OIS_mem_write( _M_EQCTL, 0x0c0c ); //sever on
//	I2C_OIS_mem_write( _M_EQCTL, 0x0d0d ); //ois open
